...
if __name__ == '__main__':
    ...
    # else:
    model.load_state_dict(torch.load("./model_saved/{}_{}_ourmodel_{}_sigma{}_pattern_{}_best.pth".format(args.dataset,args.method,args.noise_name,args.sigma,args.pattern)))
    model.cuda()
    ...
    print('start')
    if os.path.exists('./results/{}/{}_{}_{}_sigma{}_results_pattern_{}_pA.npy'.format(args.dataset,args.dataset,args.method,args.noise_name,args.sigma,args.pattern)):
        pA_list = np.load('./results/{}/{}_{}_{}_sigma{}_results_pattern_{}_pA.npy'.format(args.dataset,args.dataset,args.method,args.noise_name,args.sigma,args.pattern)).tolist()
        R_list=np.load('./results/{}/{}_{}_{}_sigma{}_results_pattern_{}_radius.npy'.format(args.dataset,args.dataset,args.method,args.noise_name,args.sigma,args.pattern)).tolist()
        variance_term_list=np.load('./results/{}/{}_{}_{}_sigma{}_results_pattern_{}_varianceterm.npy'.format(args.dataset,args.dataset,args.method,args.noise_name,args.sigma,args.pattern)).tolist()
        dif=len(pA_list)
    else:
        pA_list = []
        R_list=[]
    ...
    for j in tqdm(range(10000-dif)):
        ...
        np.save('./results/{}/{}_{}_{}_sigma{}_results_pattern_{}_pA.npy'.format(args.dataset,args.dataset,args.method,args.noise_name,args.sigma,args.pattern), pA_list)
        np.save('./results/{}/{}_{}_{}_sigma{}_results_pattern_{}_radius.npy'.format(args.dataset,args.dataset,args.method,args.noise_name,args.sigma,args.pattern), R_list)
        np.save('./results/{}/{}_{}_{}_sigma{}_results_pattern_{}_varianceterm.npy'.format(args.dataset,args.dataset,args.method,args.noise_name,args.sigma,args.pattern), variance_term_list)