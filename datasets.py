...
IMAGENET_LOC_ENV = "/scr/home/data/imagenet"
...
def get_normalize_layer(dataset: str) -> torch.nn.Module:
    ...
    if dataset == "imagenet":
        ...
        return NormalizeLayer_MNIST(_MNIST_MEAN,_MNIST_STDDEV)
...
def _mnist(split: str) -> Dataset:
    if split =="train":
        ...
        return datasets.MNIST("./dataset_cache", train=False, download=True,
                                  transform=transforms.ToTensor())
